...
public class Int101Homework01 {
   ...
   static void work03UseOfUtilityClass() {
    System.out.println("calculateBMI =" + Myutil.calculateBMI(60,170));
    System.out.println("average =" + Myutil.average(4,1 ,4));
      /*
   ...
   static void work04UseOfObjectClass() {
        ...
        BankAccount account1 = new BankAccount(001,A);
        Person B = new Person(2);
        BankAccount account2 = new BankAccount(002,B);
